...
class CLIPTokenizer:
    def __init__(self, bpe_path=None, **kwargs):
        if bpe_path is None:
            bpe_path = "bpe_simple_vocab_16e6.txt.gz"  # "https://github.com/openai/CLIP/blob/main/clip/bpe_simple_vocab_16e6.txt.gz?raw=true",
    ...
    def __call__(self, text: str) -> torch.Tensor:
        ...
        return torch.LongTensor(encoded_text)[None, :]
